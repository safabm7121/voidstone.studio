...
function App() {
  ...
  // ✨ NEW: Detect if this is a touch device
  ...
  useEffect(() => {
    // 🛑 CRITICAL FIX: Don't run mouse tracking on touch devices
  ...
  }, [mouseMoved, isTouchDevice]); // Added isTouchDevice to dependencies
      ...
      <AuthProvider>
        <CartProvider>
          <Router>
            ...
            <MouseTracker>
              {/* ✨ CRITICAL FIX: Only show mouse glow on non-touch devices */}
              {!isTouchDevice && (
