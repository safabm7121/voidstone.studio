...
const ImageGallery: React.FC<ImageGalleryProps> = ({
  ...
  // Reordering function (exactly like your working ImageSlider)
  ...
  return (
    <>
      <Box className="gallery-container">
          ...
          {localImages.length > 1 && (
            <>
              <Tooltip title="Previous">
                <IconButton className="nav-arrow left" onClick={handlePrev}>
                  <ChevronLeftIcon />
                </IconButton>
              </Tooltip>
              <Tooltip title="Next">
                <IconButton className="nav-arrow right" onClick={handleNext}>
                  <ChevronRightIcon />
                </IconButton>
              </Tooltip>
            </>
        ...
        {isEditable && (
          <div className="admin-buttons">
            <Tooltip title="Delete current image">
              <IconButton onClick={handleDelete} className="admin-delete">
                <DeleteIcon />
              </IconButton>
            </Tooltip>
            <Tooltip title="Add images">
              <IconButton onClick={() => setAddDialogOpen(true)} className="admin-add">
        ...
        {/* Thumbnail Strip - Clickable + Reorderable (exactly like working ImageSlider) */}
